...
import { ChatBubble, ChatDateDivider, ChatRoomHeader } from "@/app/_components/ChatBubble";
import { CommentSection } from "@/app/_components/CommentSection";
import { ReactionBar } from "@/app/_components/ReactionBar";
...
export const StoryPageClient = ({ storyId, initialStory }: StoryPageClientProps) => {
  ...
  const load = useCallback(async () => {
    ...
    const response = await fetch(`/api/stories/${storyId}?sessionId=${encodeURIComponent(sessionId)}`);
    if (response.ok) {
