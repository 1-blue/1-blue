  ...
  if (isMe) {
    return (
      <div className="flex justify-end">
        <div className="bubble-me max-w-[82%] px-3.5 py-2.5 text-[15px] leading-relaxed whitespace-pre-wrap break-words">
          {content}
        </div>
      </div>
    );
  ...
  return (
    <div className="flex gap-2.5">
      ...
      <div className="min-w-0 max-w-[82%]">
        ...
        <div className="bubble-other px-3.5 py-2.5 text-[15px] leading-relaxed whitespace-pre-wrap break-words">
          {content}
        </div>
      </div>
    </div>
