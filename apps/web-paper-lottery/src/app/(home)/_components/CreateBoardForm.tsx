...
import { ParticipantRowEditor } from "@/app/(home)/_components/ParticipantRowEditor";
import { PrizeConfigEditor } from "@/app/(home)/_components/PrizeConfigEditor";
  ...
  return (
    <section className="paper-texture space-y-5 rounded-2xl border-2 border-[#d9c4a0] p-5 shadow-md">
      ...
      <div className="space-y-2">
        <Label
          htmlFor="slotCount"
          className="text-ink/80 text-xs font-bold tracking-wide uppercase"
        >
          인원 수 (칸 수)
        </Label>
