...
export const kpopHits = defineSeedCbt({
  ...
  questions: [
    ...
    {
      content:
        "2012년 유튜브 조회수가 전 세계적으로 폭발하며 K-팝 붐의 상징이 된 싸이의 곡은?",
    ...
    {
      content:
        "아이돌 그룹 BTS의 소속사는 하이브(구 빅히트)입니다.\nBTS의 팬덤 이름은?",
    ...
    {
      content:
        "2016년 데뷔 후 'TT', 'Cheer Up' 등으로 대중성을 입증한 9인조 걸그룹은?",
      choices: ["TWICE", "Red Velvet", "(G)I-DLE", "ITZY"],
      correctIndex: 0,
      explanation: "TWICE는 JYP 소속으로 데뷔곡부터 연속 히트를 내며 K-팝 대표 걸그룹이 되었습니다.",
    },
    {
      content:
    ...
    {
      content:
        "2022년 코첼라 메인 스테이지에 K-팝 걸그룹으로 첫 출연한 그룹은?",
    ...
    },
    {
      ...
      correctIndex: 0,
      explanation: "'좋은 날'은 후렴의 3단 고음으로 큰 화제를 모으며 아이유의 대표 히트가 되었습니다.",
    },
    {
      content:
    ...
    {
      content:
        "K-팝 앨범 판매·차트에서 '컴백'이란 무엇을 의미하나요?",
      choices: [
        "그룹 해체 후 재결합",
        "새 앨범·활동으로 가요계에 복귀",
        "해외 투어 종료",
