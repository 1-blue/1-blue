  ...
  return (
    ...
    >
      ...
      <nav className="text-ink-muted flex items-center gap-4 text-xs font-semibold sm:text-sm">
        <Link href="/ranking" className="hover:text-ink underline-offset-2 hover:underline">
          랭킹
        </Link>
        <Link href="/archive" className="hover:text-ink underline-offset-2 hover:underline">
          아카이브
        </Link>
      </nav>
    </header>
