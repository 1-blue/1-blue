...
export const HomePage = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const data = (await res.json()) as { result?: SubmitResultView & { rank: number }; error?: string };
    ...
    <>
      ...
      {(phase === "play" || phase === "submitting") && (
        <div className="space-y-4 py-2">
          ...
          <div
            className={
              mode === "open" ? "space-y-6 lg:grid lg:grid-cols-2 lg:items-start lg:gap-6 lg:space-y-0" : ""
            }
          >
